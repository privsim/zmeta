...
zi light zdharma-continuum/zinit-crasis
...
zi load helix-editor/helix

# Arkade - handle arch naming
zi ice from'gh-r' as'program' lbin'arkade* -> arkade' nocompile
zi load alexellis/arkade

# Eza - renamed binary per platform
zi ice from'gh-r' as'program' lbin'eza* -> eza' nocompile
