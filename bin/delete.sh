...
files=(
  ...
  "/usr/local/lib/libykhsmauth.2.4.2.dylib"
  "/usr/local/lib/libyubihsm.2.4.2.dylib"
  "/usr/local/lib/libyubihsm_http.2.4.2.dylib"
  "/usr/local/lib/libyubihsm_usb.2.4.2.dylib"
)

# List of header files to delete
headers=(
  ...
  "/usr/local/include/pkcs11/pkcs11.h"
  "/usr/local/include/pkcs11/pkcs11y.h"
  "/usr/local/include/ykhsmauth.h"
  "/usr/local/include/yubihsm.h"
)
